...
public class PlayerController {
    ...
    public int getPlayersCount(
        ...
        FilterDto filterDto = playerService.mapRequestParamToFilterDto(name, title, race, profession, minExperience, maxExperience, minLevel, maxLevel, after, before, banned, order, pageNumber, pageSize);
    ...
    public List<Player> getPlayersList(
        ...
        FilterDto filterDto = playerService.mapRequestParamToFilterDto(name, title, race, profession, minExperience, maxExperience, minLevel, maxLevel, after, before, banned, order, pageSize, pageNumber);
